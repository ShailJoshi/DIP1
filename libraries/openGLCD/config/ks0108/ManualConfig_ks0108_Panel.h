...
#define GLCD_tDDR   1   /* Data Delay time (E high to valid read data)        */
#define GLCD_tAS    1    /* Address setup time (ctrl line changes to E high)   */
#define GLCD_tDSW   1    /* Data setup time (data lines setup to dropping E)   */
#define GLCD_tWH    1    /* E hi level width (minimum E hi pulse width)        */
#define GLCD_tWL    1    /* E lo level width (minimum E lo pulse width)        */
